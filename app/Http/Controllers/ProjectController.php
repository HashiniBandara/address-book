...
public function getActiveCustomers($projectId)
{
    // Get the active customers
    $customers = Customer::where('status', 'active')->get();

    // Get the customers already associated with the project
    $project = Project::with('customers')->find($projectId);
    $associatedCustomers = $project->customers->pluck('id')->toArray();
